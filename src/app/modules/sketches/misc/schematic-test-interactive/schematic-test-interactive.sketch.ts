...
export const schematicTestInteractive: Sketch = {
  title: 'schematicTestInteractive',
  width: undefined,
  height: undefined,
  isSvg: false,
  controls: {
  ...
  func: (p5: P5) => {
    ...
    p5.setup = () => {
      createCanvasOnParentContainer(p5, {
        width: schematicTestInteractive.width,
        height: schematicTestInteractive.height,
        useSvg: schematicTestInteractive.isSvg,
      });
